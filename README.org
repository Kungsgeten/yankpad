...
4. Optionally install =yasnippet= and/or =projectile=, if you want the additional yankpad features that those package provide.
5. That's it!
...
- 2.41 (March 2025) :: Remove =company-yankpad= in favor =yankpad-capf=, to support =completion-at-point=.
